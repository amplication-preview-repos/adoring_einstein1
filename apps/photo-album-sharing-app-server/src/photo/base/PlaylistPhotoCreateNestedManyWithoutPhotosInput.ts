...
@InputType()
class PlaylistPhotoCreateNestedManyWithoutPhotosInput {
...
export { PlaylistPhotoCreateNestedManyWithoutPhotosInput as PlaylistPhotoCreateNestedManyWithoutPhotosInput };
