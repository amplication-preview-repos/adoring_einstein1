...
@InputType()
class PlaylistPhotoCreateNestedManyWithoutPlaylistsInput {
...
export { PlaylistPhotoCreateNestedManyWithoutPlaylistsInput as PlaylistPhotoCreateNestedManyWithoutPlaylistsInput };
